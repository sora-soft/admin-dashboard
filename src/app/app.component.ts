...
import {AuthName} from './service/auth.service';
        ...
        children: [
          {
            ...
            route: AppPath.AccountListPage
          },
          {
            type: 'link',
            label: '用户组',
            auth: AuthName.UI_Account_AuthGroup,
            route: AppPath.AccountGroupPage
          }
        ],
        // route: AppPath.AccountManagePage,
